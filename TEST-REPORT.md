...
Run on 2026-09-26 against commit `dda1d62` + the changes in this report's commit, on macOS (Chrome channel, local PostgreSQL 16 on `127.0.0.1:5439`, Supabase project `bhzbegsqkpmzssmznnaf` test bucket `media-test` for the real-upload cases only).
